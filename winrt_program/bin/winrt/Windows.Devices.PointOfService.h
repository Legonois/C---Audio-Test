...
namespace winrt::impl
{
    ...
    {
        void* preview{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::PointOfService::IBarcodeScannerImagePreviewReceivedEventArgs)->get_Preview(&preview));
        return winrt::Windows::Storage::Streams::IRandomAccessStreamWithContentType{ preview, take_ownership_from_abi };
    }
    ...
    {
        void* drawer{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::PointOfService::ICashDrawerEventSourceEventArgs)->get_CashDrawer(&drawer));
        return winrt::Windows::Devices::PointOfService::CashDrawer{ drawer, take_ownership_from_abi };
    }
    ...
    {
        void* escapeSequence{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::PointOfService::ILineDisplayStoredBitmap)->get_EscapeSequence(&escapeSequence));
    ...
    struct produce<D, winrt::Windows::Devices::PointOfService::IBarcodeScannerImagePreviewReceivedEventArgs> : produce_base<D, winrt::Windows::Devices::PointOfService::IBarcodeScannerImagePreviewReceivedEventArgs>
    {
        int32_t __stdcall get_Preview(void** preview) noexcept final try
        {
            clear_abi(preview);
            typename D::abi_guard guard(this->shim());
            *preview = detach_from<winrt::Windows::Storage::Streams::IRandomAccessStreamWithContentType>(this->shim().Preview());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
    ...
    struct produce<D, winrt::Windows::Devices::PointOfService::ICashDrawerEventSourceEventArgs> : produce_base<D, winrt::Windows::Devices::PointOfService::ICashDrawerEventSourceEventArgs>
    {
        int32_t __stdcall get_CashDrawer(void** drawer) noexcept final try
        {
            clear_abi(drawer);
            typename D::abi_guard guard(this->shim());
            *drawer = detach_from<winrt::Windows::Devices::PointOfService::CashDrawer>(this->shim().CashDrawer());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
