...
namespace winrt::impl
{
    ...
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::ApplicationModel::AppService::IAppServiceRequestReceivedEventArgs)->GetDeferral(&value));
        return winrt::Windows::ApplicationModel::AppService::AppServiceDeferral{ value, take_ownership_from_abi };
    }
    ...
    struct produce<D, winrt::Windows::ApplicationModel::AppService::IAppServiceRequestReceivedEventArgs> : produce_base<D, winrt::Windows::ApplicationModel::AppService::IAppServiceRequestReceivedEventArgs>
    {
        ...
        int32_t __stdcall GetDeferral(void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
            *value = detach_from<winrt::Windows::ApplicationModel::AppService::AppServiceDeferral>(this->shim().GetDeferral());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
