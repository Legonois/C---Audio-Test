...
namespace winrt::impl
{
    ...
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::System::IDispatcherQueueShutdownStartingEventArgs)->GetDeferral(&value));
    ...
    {
        void* deferral{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::System::IUserAuthenticationStatusChangingEventArgs)->GetDeferral(&deferral));
        return winrt::Windows::System::UserAuthenticationStatusChangeDeferral{ deferral, take_ownership_from_abi };
    }
    ...
    template <typename D> auto consume_Windows_System_IUserPicker<D>::PickSingleUserAsync() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::System::IUserPicker)->PickSingleUserAsync(&pickSingleUserOperation));
        return winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::System::User>{ pickSingleUserOperation, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_System_IUserPickerStatics<D>::IsSupported() const
    {
        bool value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::System::IUserPickerStatics)->IsSupported(&value));
        return value;
    }
    template <typename D> auto consume_Windows_System_IUserStatics<D>::CreateWatcher() const
    {
        void* watcher{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::System::IUserStatics)->CreateWatcher(&watcher));
        return winrt::Windows::System::UserWatcher{ watcher, take_ownership_from_abi };
    }
    ...
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::System::IUserStatics)->GetFromId(*(void**)(&nonRoamableId), &value));
        return winrt::Windows::System::User{ value, take_ownership_from_abi };
    }
    ...
    struct produce<D, winrt::Windows::System::IUserAuthenticationStatusChangingEventArgs> : produce_base<D, winrt::Windows::System::IUserAuthenticationStatusChangingEventArgs>
    {
        int32_t __stdcall GetDeferral(void** deferral) noexcept final try
        {
            clear_abi(deferral);
            typename D::abi_guard guard(this->shim());
            *deferral = detach_from<winrt::Windows::System::UserAuthenticationStatusChangeDeferral>(this->shim().GetDeferral());
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall get_User(void** value) noexcept final try
    ...
    struct produce<D, winrt::Windows::System::IUserPicker> : produce_base<D, winrt::Windows::System::IUserPicker>
    {
        ...
        int32_t __stdcall PickSingleUserAsync(void** pickSingleUserOperation) noexcept final try
        {
            ...
            typename D::abi_guard guard(this->shim());
            *pickSingleUserOperation = detach_from<winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::System::User>>(this->shim().PickSingleUserAsync());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
    ...
    struct produce<D, winrt::Windows::System::IUserStatics> : produce_base<D, winrt::Windows::System::IUserStatics>
    {
        int32_t __stdcall CreateWatcher(void** watcher) noexcept final try
        {
            clear_abi(watcher);
            typename D::abi_guard guard(this->shim());
            *watcher = detach_from<winrt::Windows::System::UserWatcher>(this->shim().CreateWatcher());
            return 0;
        }
        catch (...) { return to_hresult(); }
        ...
        int32_t __stdcall GetFromId(void* nonRoamableId, void** value) noexcept final try
        {
            clear_abi(value);
            typename D::abi_guard guard(this->shim());
            *value = detach_from<winrt::Windows::System::User>(this->shim().GetFromId(*reinterpret_cast<hstring const*>(&nonRoamableId)));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
