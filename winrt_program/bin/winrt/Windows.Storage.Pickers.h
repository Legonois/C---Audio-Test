...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_Storage_Pickers_IFileOpenPicker<D>::PickSingleFileAsync() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Storage::Pickers::IFileOpenPicker)->PickSingleFileAsync(&pickSingleFileOperation));
        return winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Storage::StorageFile>{ pickSingleFileOperation, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_Storage_Pickers_IFileOpenPicker<D>::PickMultipleFilesAsync() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Storage::Pickers::IFileOpenPicker)->PickMultipleFilesAsync(&pickMultipleFilesOperation));
        return winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Foundation::Collections::IVectorView<winrt::Windows::Storage::StorageFile>>{ pickMultipleFilesOperation, take_ownership_from_abi };
    }
    ...
    {
        void* pickSingleFileOperation{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Storage::Pickers::IFileOpenPickerStatics)->ResumePickSingleFileAsync(&pickSingleFileOperation));
        return winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Storage::StorageFile>{ pickSingleFileOperation, take_ownership_from_abi };
    }
    ...
    {
        void* pickSingleFileOperation{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Storage::Pickers::IFileOpenPickerWithOperationId)->PickSingleFileAsync(*(void**)(&pickerOperationId), &pickSingleFileOperation));
        return winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Storage::StorageFile>{ pickSingleFileOperation, take_ownership_from_abi };
    }
    ...
    template <typename D> auto consume_Windows_Storage_Pickers_IFileSavePicker<D>::PickSaveFileAsync() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Storage::Pickers::IFileSavePicker)->PickSaveFileAsync(&pickSaveFileOperation));
        return winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Storage::StorageFile>{ pickSaveFileOperation, take_ownership_from_abi };
    }
    ...
    template <typename D> auto consume_Windows_Storage_Pickers_IFolderPicker<D>::PickSingleFolderAsync() const
    {
        ...
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Storage::Pickers::IFolderPicker)->PickSingleFolderAsync(&pickSingleFolderOperation));
        return winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Storage::StorageFolder>{ pickSingleFolderOperation, take_ownership_from_abi };
    }
    ...
    struct produce<D, winrt::Windows::Storage::Pickers::IFileOpenPicker> : produce_base<D, winrt::Windows::Storage::Pickers::IFileOpenPicker>
    {
        ...
        int32_t __stdcall PickSingleFileAsync(void** pickSingleFileOperation) noexcept final try
        {
            ...
            typename D::abi_guard guard(this->shim());
            *pickSingleFileOperation = detach_from<winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Storage::StorageFile>>(this->shim().PickSingleFileAsync());
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall PickMultipleFilesAsync(void** pickMultipleFilesOperation) noexcept final try
        {
            ...
            typename D::abi_guard guard(this->shim());
            *pickMultipleFilesOperation = detach_from<winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Foundation::Collections::IVectorView<winrt::Windows::Storage::StorageFile>>>(this->shim().PickMultipleFilesAsync());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
    ...
    struct produce<D, winrt::Windows::Storage::Pickers::IFileOpenPickerStatics> : produce_base<D, winrt::Windows::Storage::Pickers::IFileOpenPickerStatics>
    {
        int32_t __stdcall ResumePickSingleFileAsync(void** pickSingleFileOperation) noexcept final try
        {
            clear_abi(pickSingleFileOperation);
            typename D::abi_guard guard(this->shim());
            *pickSingleFileOperation = detach_from<winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Storage::StorageFile>>(this->shim().ResumePickSingleFileAsync());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
    ...
    struct produce<D, winrt::Windows::Storage::Pickers::IFileOpenPickerWithOperationId> : produce_base<D, winrt::Windows::Storage::Pickers::IFileOpenPickerWithOperationId>
    {
        int32_t __stdcall PickSingleFileAsync(void* pickerOperationId, void** pickSingleFileOperation) noexcept final try
        {
            clear_abi(pickSingleFileOperation);
            typename D::abi_guard guard(this->shim());
            *pickSingleFileOperation = detach_from<winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Storage::StorageFile>>(this->shim().PickSingleFileAsync(*reinterpret_cast<hstring const*>(&pickerOperationId)));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
    ...
    struct produce<D, winrt::Windows::Storage::Pickers::IFileSavePicker> : produce_base<D, winrt::Windows::Storage::Pickers::IFileSavePicker>
    {
        ...
        int32_t __stdcall PickSaveFileAsync(void** pickSaveFileOperation) noexcept final try
        {
            ...
            typename D::abi_guard guard(this->shim());
            *pickSaveFileOperation = detach_from<winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Storage::StorageFile>>(this->shim().PickSaveFileAsync());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
    ...
    struct produce<D, winrt::Windows::Storage::Pickers::IFolderPicker> : produce_base<D, winrt::Windows::Storage::Pickers::IFolderPicker>
    {
        ...
        int32_t __stdcall PickSingleFolderAsync(void** pickSingleFolderOperation) noexcept final try
        {
            ...
            typename D::abi_guard guard(this->shim());
            *pickSingleFolderOperation = detach_from<winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Storage::StorageFolder>>(this->shim().PickSingleFolderAsync());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
