...
WINRT_EXPORT namespace winrt::Windows::Web::Http
{
    ...
    struct __declspec(empty_bases) HttpClient : winrt::Windows::Web::Http::IHttpClient,
        impl::require<HttpClient, winrt::Windows::Foundation::IStringable>
    {
    ...
    struct __declspec(empty_bases) HttpMultipartContent : winrt::Windows::Web::Http::IHttpContent,
        impl::require<HttpMultipartContent, winrt::Windows::Foundation::Collections::IIterable<winrt::Windows::Web::Http::IHttpContent>, winrt::Windows::Web::Http::IHttpMultipartContent, winrt::Windows::Foundation::IStringable>
    {
    ...
    struct __declspec(empty_bases) HttpMultipartFormDataContent : winrt::Windows::Web::Http::IHttpContent,
        impl::require<HttpMultipartFormDataContent, winrt::Windows::Foundation::Collections::IIterable<winrt::Windows::Web::Http::IHttpContent>, winrt::Windows::Web::Http::IHttpMultipartFormDataContent, winrt::Windows::Foundation::IStringable>
    {
    ...
    struct __declspec(empty_bases) HttpRequestMessage : winrt::Windows::Web::Http::IHttpRequestMessage,
        impl::require<HttpRequestMessage, winrt::Windows::Foundation::IStringable>
    {
    ...
    struct __declspec(empty_bases) HttpResponseMessage : winrt::Windows::Web::Http::IHttpResponseMessage,
        impl::require<HttpResponseMessage, winrt::Windows::Foundation::IStringable>
    {
