...
WINRT_EXPORT namespace winrt::Windows::Devices::PointOfService::Provider
{
    ...
    struct __declspec(empty_bases) IBarcodeScannerFrameReader :
        ...
        impl::require<winrt::Windows::Devices::PointOfService::Provider::IBarcodeScannerFrameReader, winrt::Windows::Foundation::IClosable>
    {
    ...
    struct __declspec(empty_bases) IBarcodeScannerProviderConnection :
        ...
        impl::require<winrt::Windows::Devices::PointOfService::Provider::IBarcodeScannerProviderConnection, winrt::Windows::Foundation::IClosable>
    {
    ...
    struct __declspec(empty_bases) IBarcodeScannerProviderConnection2 :
        ...
        impl::require<winrt::Windows::Devices::PointOfService::Provider::IBarcodeScannerProviderConnection2, winrt::Windows::Foundation::IClosable>
    {
    ...
    struct __declspec(empty_bases) IBarcodeScannerVideoFrame :
        ...
        impl::require<winrt::Windows::Devices::PointOfService::Provider::IBarcodeScannerVideoFrame, winrt::Windows::Foundation::IClosable>
    {
