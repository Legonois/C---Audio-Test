...
WINRT_EXPORT namespace winrt::Windows::UI::Xaml::Input
{
    ...
    struct __declspec(empty_bases) StandardUICommand : winrt::Windows::UI::Xaml::Input::IStandardUICommand,
        ...
        impl::require<StandardUICommand, winrt::Windows::UI::Xaml::Input::IXamlUICommand, winrt::Windows::UI::Xaml::Input::ICommand, winrt::Windows::UI::Xaml::IDependencyObject, winrt::Windows::UI::Xaml::IDependencyObject2>
    {
