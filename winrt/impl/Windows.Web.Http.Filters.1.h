...
WINRT_EXPORT namespace winrt::Windows::Web::Http::Filters
{
    struct __declspec(empty_bases) IHttpBaseProtocolFilter :
        ...
        impl::require<winrt::Windows::Web::Http::Filters::IHttpBaseProtocolFilter, winrt::Windows::Foundation::IClosable, winrt::Windows::Web::Http::Filters::IHttpFilter>
    {
    ...
    struct __declspec(empty_bases) IHttpBaseProtocolFilter2 :
        ...
        impl::require<winrt::Windows::Web::Http::Filters::IHttpBaseProtocolFilter2, winrt::Windows::Foundation::IClosable, winrt::Windows::Web::Http::Filters::IHttpFilter>
    {
    ...
    struct __declspec(empty_bases) IHttpBaseProtocolFilter3 :
        ...
        impl::require<winrt::Windows::Web::Http::Filters::IHttpBaseProtocolFilter3, winrt::Windows::Foundation::IClosable, winrt::Windows::Web::Http::Filters::IHttpFilter>
    {
    ...
    struct __declspec(empty_bases) IHttpBaseProtocolFilter4 :
        ...
        impl::require<winrt::Windows::Web::Http::Filters::IHttpBaseProtocolFilter4, winrt::Windows::Foundation::IClosable, winrt::Windows::Web::Http::Filters::IHttpFilter>
    {
