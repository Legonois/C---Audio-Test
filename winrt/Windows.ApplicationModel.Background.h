...
namespace winrt::impl
{
    ...
    {
        void* trigger{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::ApplicationModel::Background::IPushNotificationTriggerFactory)->Create(*(void**)(&applicationId), &trigger));
        return winrt::Windows::ApplicationModel::Background::PushNotificationTrigger{ trigger, take_ownership_from_abi };
    }
    ...
    struct produce<D, winrt::Windows::ApplicationModel::Background::IPushNotificationTriggerFactory> : produce_base<D, winrt::Windows::ApplicationModel::Background::IPushNotificationTriggerFactory>
    {
        int32_t __stdcall Create(void* applicationId, void** trigger) noexcept final try
        {
            clear_abi(trigger);
            typename D::abi_guard guard(this->shim());
            *trigger = detach_from<winrt::Windows::ApplicationModel::Background::PushNotificationTrigger>(this->shim().Create(*reinterpret_cast<hstring const*>(&applicationId)));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
